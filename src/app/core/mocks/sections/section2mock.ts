export const section2Mocks: any[][] = [
  [
    {
      title: [
        'ავტომობილების ინფორმაციის აღრიცხვა',
        'Vehicle information recording',
        'Запись информации о транспортном средстве',
      ],
      order: 0,
    },
    {
      title: [
        'ავტოსერვისის პროცესის აღრიცხვა',
        'Auto service process accounting',
        'Учет процесса автосервиса',
      ],
      order: 1,
    },
    {
      title: [
        'გარანტიების აღრიცხვა',
    ...
    {
      title: ['ვიზიტების დაგეგმვა', 'Planning visits', 'Планирование визитов'],
      order: 6,
    },
  ],
  [
    {
      title: [
        'სერვისში მისაღები ავტომობილების დეტალური ინფორმაციის შენახვა, აღრიცხვა, მართვა, მათ შორის ავტომობილების მფლობელების ინფორმაცია. შესაძლებელია თითოეული ავტომობილისთვის ისტორიულად ყველა ჩატარებული სერვისის ინფორმაციისა და საგარანტიო პირობების ნახვა.',
    ...
    {
      title: [
        'პროგრამულად ფიქსირდება და აღირიცხება: ტექნიკის მიღება, ბოქსში განაწილება, ოსტატზე მიმაგრება, ნამუშევარი დროის აღრიცხვა, დეფექტური აქტისა და ხარჯთაღრიცხვის შედგენა, მიღება-ჩაბარების გაფორმება',
    ...
    {
      title: [
        'პროგრამულად შესაძლებელია საგარანტიო პირობების შევსება თითოეული ავტომობილისთვის, როგორც მწარმოებლის, ასევე შიდა გარანტიების აღრიცხვა.',
    ...
    {
      title: [
        'მანქანის სერვისში მიღების შემდეგ ავტოსერვისის დავალებას ემაგრება ოსტატი - ხოლო ოსტატის დავალებაზე მუშაობის პროცესში შესაძლებელია დახარჯული დროის აღრიცხვა. რეპორტებში გამოჩნდება თითოეული ოსტატის მიერ დახარჯული ჯამური საათები, ხოლო ასანაზღაურებელი თანხა გამოითვლება ავტომატურად.',
    ...
    {
      title: [
        'შესაძლებელია არსებული მარაგების შესახებ ინფორმაციის მიღება Live რეჟიმში. საბუღალტრო სისტემებთან ინტეგრაცია მოგცემთ სრულ ხედვას საწყობებზე არსებულ ნაშთებზე და საშუალებას მოგცემთ ავტოსერვისის გაწევისას გამოყენებული ნაწილები და სახარჯი მასალები ავტომატურად ჩამოწეროთ მარაგებიდან. შესაძლებელია მარაგების აღრიცხვა და მართვა სხვა სისტემებთან ინტეგრაციის გარეშეც.',
    ...
    {
      title: [
        'გაციფრულებულია კომპანიებთან დადებული ხელშეკრულებები და პრეისკურანტი. მის მიხედვით აღირიცხება სახელშეკრულებო ვადის განმავლობაში სერვისის გაწევისას ნაწილების, შეკეთებისა და სახარჯი მასალების ფასები. ასევე შესაძლებელია ხელშეკრულებით განსაზღვრული ჯამური თანხის კონტროლი თითოეული მომსახურების გაწევისას.',
    ...
    {
      title: [
        'შესაძლებელია ავტომობილების წინასწარი ჩაწერა სერვისის მისაღებად როგორც სერვის-ცენტრში ასევე ოსტატის მივლინებით, რაც საშუალებას იძლევა თავიდან აიცილოთ რიდები ავტოსერვისში და სწორად გაანაწილოთ ოსტატების სამუშაო დრო.',
